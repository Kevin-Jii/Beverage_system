                    ...
                    <a-col :span="12">
                      <a-form-item field="cid" label="选择分类" validate-trigger="input" >
                        <a-select v-model="formData.cid" :options="cateList" placeholder="请选择分类" />
										...
										<a-col :span="12">
											<a-form-item field="description" label="描述" :rules="[{required:true,message:'请填写描述'}]" >
													<a-input v-model="formData.description" placeholder="请填描述" />
											</a-form-item>
										</a-col>
										<a-col :span="12">
											<a-form-item field="thumb" label="缩略图" :rules="[{required:true,message:'请填写缩略图'}]" >
													<a-input v-model="formData.thumb" placeholder="请填缩略图" />
											</a-form-item>
										</a-col>
										<a-col :span="12">
											<a-form-item field="unit" label="单位" :rules="[{required:true,message:'请填写单位'}]" >
													<a-input v-model="formData.unit" placeholder="请填单位" />
											</a-form-item>
										</a-col>
										<a-col :span="12">
											<a-form-item field="weigh" label="排序" :rules="[{required:true,message:'请填写排序'}]" >
													<a-input-number v-model="formData.weigh" placeholder="请填排序" />
											</a-form-item>
										</a-col>
										<a-col :span="12">
											<a-form-item field="status" label="状态:0=隐藏;1=正常" >
													<a-radio-group v-model="formData.status" :options="SHoptions" />
											</a-form-item>
										</a-col>
                    </a-row>
                </div>
...
<script lang="ts">
  ...
  //api
  import { save,getContent } from '@/api/vaccine/content';
  import { getCate } from '@/api/vaccine/contentcate';
