                    ...
                    <a-col :span="12">
                      <a-form-item field="cid" label="选择分类" validate-trigger="input" >
                        <a-select v-model="formData.cid" :options="cateList" placeholder="请选择分类" />
										...
										<a-col :span="12">
											<a-form-item field="accountID" label="账号id" :rules="[{required:true,message:'请填写账号id'}]" >
													<a-input-number v-model="formData.accountID" placeholder="请填账号id" />
											</a-form-item>
										</a-col>
										<a-col :span="12">
											<a-form-item field="businessID" label="业务主账号id" :rules="[{required:true,message:'请填写业务主账号id'}]" >
													<a-input-number v-model="formData.businessID" placeholder="请填业务主账号id" />
											</a-form-item>
										</a-col>
										<a-col :span="12">
											<a-form-item field="age" label="年龄" :rules="[{required:true,message:'请填写年龄'}]" >
													<a-input-number v-model="formData.age" placeholder="请填年龄" />
											</a-form-item>
										</a-col>
										<a-col :span="12">
...
<script lang="ts">
  ...
  //api
  import { save,getContent } from '@/api/createcode/code';
  import { getCate } from '@/api/createcode/codecate';
