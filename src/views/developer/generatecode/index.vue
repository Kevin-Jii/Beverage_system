      ...
      >
        ...
        <template #operations="{ record }">
          <ButtonGroup size="small">
            ...
            <a-popconfirm content="您确定要删除数据库和代码吗?" @ok="handleDel(record)">
...
<script lang="ts" setup>
  ...
  //api
  import { getList,upStatus,del,save} from '@/api/developer/generatecode';
  ...
  const timeFormatter=(value:any)=>{
    const dateForUi = new Date(value).toLocaleString('zh-CN');
    return dateForUi
  }
</script>
