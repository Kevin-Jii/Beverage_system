...
enum Api {
    getList = '/vaccine/content/get_list',
    getContent= '/vaccine/content/get_content',
    save = '/vaccine/content/save',
    upStatus = '/vaccine/content/upStatus',
    del = '/vaccine/content/del',
}
