...
enum Api {
    getList = '/vaccine/contentcate/get_list',
    getCate = '/vaccine/contentcate/get_cate',
    save = '/vaccine/contentcate/save',
    upStatus = '/vaccine/contentcate/upStatus',
    del = '/vaccine/contentcate/del',
}
