...
enum Api {
    getList = '/createcode/code/get_list',
    getContent= '/createcode/code/get_content',
    save = '/createcode/code/save',
    upStatus = '/createcode/code/upStatus',
    del = '/createcode/code/del',
}
