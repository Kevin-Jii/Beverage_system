...
enum Api {
    getList = '/createcode/band/get_list',
    getContent= '/createcode/band/get_content',
    save = '/createcode/band/save',
    upStatus = '/createcode/band/upStatus',
    del = '/createcode/band/del',
}
